    ...
    <main id="shop-page">
      ...
      <section className="shop-hero" aria-label="Tienda header">
        <div className="container">
          ...
          <h1 className="section-title" style={{ fontSize: "clamp(2.4rem, 6vw, 4rem)" }}>
      ...
      <div className="container" style={{ paddingTop: 0 }}>
        <div style={{
          ...
          padding: "14px 0", borderBottom: "1px solid var(--border)", marginBottom: 28,
          flexWrap: "wrap", gap: 8,
        }}>
        ...
        {filtered.length > 0 ? (
          ...
          <div style={{ textAlign: "center", padding: "80px 20px", color: "var(--muted)" }}>
            ...
            <h2 style={{ fontFamily: "var(--font-head)", color: "var(--text)", fontSize: "1.6rem", letterSpacing: "0.04em", textTransform: "uppercase", marginBottom: 8 }}>
